...
**Repository Migration:** يجب حفظ Migration المقابلة في المستودع ضمن نفس سلسلة تغييرات الأمان قبل اعتبار هذه النقطة مكتملة نهائياً.

**الحالة:** `WARNING — NOT FULLY TESTED` حتى اكتمال حفظ Migration في المستودع وتشغيل CI.