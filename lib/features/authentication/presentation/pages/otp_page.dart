          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(Icons.verified_user_outlined, size: 38, color: scheme.primary),
              ),
              ...
              TextField(
                ...
                style: TextStyle(fontSize: 30, letterSpacing: 12, fontWeight: FontWeight.bold, color: scheme.onSurface),
                onChanged: (v) {
                  if (v.length == 6) {
                    _verify();
                  }
              ...
              state.isLoading
                  ...
                  : SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: const Text('تأكيد ودخول', style: TextStyle(fontWeight: FontWeight.bold)),
                      ),
                    ),
              const SizedBox(height: 12),
              TextButton(
                onPressed: () => Navigator.pop(context),
                child: Text('تغيير رقم الهاتف', style: TextStyle(color: scheme.primary)),
              ),
            ],
          ),
        ),
