              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildStepHeader(
                    '01',
                    'الصورة الشخصية',
                    'تظهر للعملاء في نتائج البحث والملف الشخصي.',
                  ),
                  ...
                  _buildStepHeader(
                    '02',
                    'وثيقة التحقق',
                    'ارفع صورة واضحة لهوية النقابة أو المستند المطلوب للمراجعة.',
                  ),
                  const SizedBox(height: 14),
                  _buildIdPicker(),
                  ...
                  Container(
                    ...
                    child: const Row(
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Text(
                            'نحافظ على سرية مستنداتك ونستخدمها لغرض التحقق من أهليتك كمحامٍ.',
                            style: TextStyle(
                              fontSize: 12,
    ...
    return Container(
      ...
      child: const Column(
        ...
        children: [
          ...
          SizedBox(height: 8),
          Text(
            'أكمل بياناتك المهنية وارفع مستندات التحقق حتى نتمكن من مراجعة طلبك بأمان.',
            style: TextStyle(color: Colors.white70, height: 1.55),
          ),
          SizedBox(height: 18),
          Row(
            children: [
              Icon(Icons.verified_user_rounded, color: AppColors.gold, size: 19),
              SizedBox(width: 8),
              Expanded(
                child: Text(
                  'بياناتك تستخدم للتحقق المهني فقط.',
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(22),
          border: Border.all(
            color: _idCardBytes == null ? AppColors.outline : AppColors.gold,
            width: _idCardBytes == null ? 1 : 2,
          ),
        ),
