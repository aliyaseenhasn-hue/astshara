  ...
  Widget _buildStatsGrid(List<Booking> bookings) {
    ...
    return GridView.count(
      ...
      children: [
        ...
        _StatCard(
          title: 'الأرباح (د.ع)',
          value: '${(totalEarnings / 1000).toStringAsFixed(1)} ألف',
...
class _StatusChip extends StatelessWidget {
  ...
  const _StatusChip({required this.status, required this.lawyerApproved});
