...
class LawyersListPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      backgroundColor:
          dark ? const Color(0xFF00483F) : const Color(0xFFF8F9FA),
              ...
              delegate: SliverChildListDelegate(
                [
                  ...
                  if (dark) ...[
                    ...
                    Text(
                      'ابحث عن نخبة المحامين والمستشارين القانونيين المعتمدين.',
                      textAlign: TextAlign.right,
                      style: TextStyle(
                  ...
                  lawyersAsync.when(
                    ...
                    data: (lawyers) {
                      ...
                      return Column(
                        children: lawyers
                            .map<Widget>(
                              (lawyer) => _LawyerCard(lawyer: lawyer),
                            )
                            .toList(),
                      );
                    },
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border(
          bottom: BorderSide(
            color: scheme.outlineVariant.withValues(alpha: dark ? .12 : .55),
          ),
        ),
      ),
      child: Row(
...
class _LawyerCard extends StatelessWidget {
  ...
  List<Widget> _specializationChips(
    ...
    return specializations.map<Widget>((specialization) {
      return Container(
  ...
  Widget build(BuildContext context) {
    ...
    final specializations = lawyer.specializations.isNotEmpty
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          InkWell(
            onTap: () => context.push(
              '/lawyer-details/${lawyer.profileId}',
            ),
                    ...
                    children: [
                      ...
                      Text(
                        lawyer.specializations.isNotEmpty
                            ? 'محامي ${specializations.split('،').first}'
          ...
          Wrap(
            ...
            spacing: 6,
            runSpacing: 6,
            children: _specializationChips(context, dark, scheme),
          ),
          ...
          Row(
            ...
            children: [
              ...
              const SizedBox(width: 4),
              Text(
                '${(lawyer.consultationPrice ?? 0).toStringAsFixed(0)} د.ع / للجلسة',
                style: TextStyle(
                  color: scheme.onSurfaceVariant,
                  fontSize: 10,
                ),
