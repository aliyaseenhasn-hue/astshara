...
class _InteractiveAdminCard extends StatefulWidget {
  ...
  @override
  State<_InteractiveAdminCard> createState() => _InteractiveAdminCardState();
}
        ...
        child: Card(
          child: ListTile(
            ...
            leading: AnimatedContainer(
              ...
              decoration: BoxDecoration(color: widget.color.withValues(alpha: _hovered ? 0.15 : 0.08), borderRadius: BorderRadius.circular(12)),
