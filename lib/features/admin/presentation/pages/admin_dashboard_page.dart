  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: statsAsync.when(
        ...
        error: (error, stackTrace) => Center(child: Padding(padding: const EdgeInsets.all(AppSizes.p20), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [const Icon(Icons.error_outline, color: AppColors.error, size: 48), const SizedBox(height: 16), const Text('تعذر تحميل الإحصائيات', textAlign: TextAlign.center), const SizedBox(height: 16), ElevatedButton(onPressed: () => ref.invalidate(adminStatsProvider), child: const Text('إعادة المحاولة'))])),
        data: (stats) => SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: AppSizes.p16),
            _buildAdminActionCard('إدارة المستخدمين', 'البحث في جميع الحسابات ومراجعة حالتها وبياناتها', Icons.people_alt_outlined, AppColors.primary, () => context.push('/admin/users')),
