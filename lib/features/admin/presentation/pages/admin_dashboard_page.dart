...
class AdminDashboardPage extends ConsumerWidget {
      ...
      body: statsAsync.when(
        data: (stats) => SingleChildScrollView(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            const SizedBox(height: AppSizes.p16),
            _buildAdminActionTile('مراجعة الدفعات المعلقة', '${stats['pending_payments']} دفعات جديدة', Icons.payment, Colors.red, () => context.push('/admin/payments')),
  ...
  Widget _buildRevenueCard(dynamic amount) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Text('${(amount as num).toStringAsFixed(0)} د.ع', style: const TextStyle(color: Colors.white, fontSize: 28, fontWeight: FontWeight.bold)),
          const SizedBox(height: 8),
