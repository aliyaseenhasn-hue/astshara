          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('تعذر تحميل الإحصائيات', textAlign: TextAlign.center),
                const SizedBox(height: 16),
        ...
        data: (stats) => SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: AppSizes.p32),
              const Text('الإدارة والمراجعات', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
              const SizedBox(height: AppSizes.p16),
              _buildAdminActionCard('إدارة المستخدمين', 'عرض جميع المستخدمين والبحث والتصفية حسب النوع والحالة)', Icons.people_alt_outlined, AppColors.primary, () => context.push('/admin/users')),
