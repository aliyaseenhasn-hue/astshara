...
final bookingClientNameProvider=FutureProvider.family<String?,String>((ref,bookingId) async { final result=await SupabaseConfig.client.rpc('get_booking_client_name',params:{'p_booking_id':bookingId}); if(result==null)return null; final name=result.toString().trim(); return name.isEmpty?null:name; });
