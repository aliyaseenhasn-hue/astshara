...
class BookingDetailsPage extends ConsumerWidget {
          ...
          _section('بيانات الدفع', Icons.receipt_long_outlined, paymentAsync.when(
            data: (payment) => payment == null
                ...
                : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    _row('حالة الدفع', _paymentStatusText(payment.status)),
  ...
  void _goToPayment(BuildContext context) => Navigator.pushNamed(context, '/upload-payment', arguments: booking);
  ...
  String _paymentStatusText(String status) => status;
