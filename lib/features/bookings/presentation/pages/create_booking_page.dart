...
class _CreateBookingPageState extends ConsumerState<CreateBookingPage> {
  ...
  bool _validateStep() {
    ...
    if (_step == 3 &&
        ref.read(currentUserWhatsAppProvider).valueOrNull == null) {
            ...
            children: [
              ...
              if (_consultationMode == 'في المكتب') ...[
                ...
                const _InfoBox(
                  ...
                  text:
                      'يبقى الحجز معلقاً حتى يسجل المحامي المبلغ المستلم. لن يبدأ رقم التواصل بالظهور قبل تأكيد الحجز.',
                ),
              ],
            ],
          ),
          ...
          child: Column(
            children: [
              ...
              _ReviewRow(
                label: 'الباقة',
                value:
                    widget.isCustom ? 'استشارة مختلفة' : (_package?.title ?? '-'),
              ),
              _ReviewRow(
                label: 'نوع الاستشارة',
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(color: AppColors.ctaGold, width: 2),
              image: hasAvatar
                  ? DecorationImage(
          ...
          Row(
            ...
            children: [
              Container(
                ...
                height: 42,
                decoration: BoxDecoration(
                  color: AppColors.tertiaryLight.withValues(alpha: .12),
                  borderRadius: BorderRadius.circular(12),
                ),
                child: Icon(icon, color: AppColors.tertiaryLight),
              ),
      ...
      child: Material(
        ...
        child: InkWell(
          ...
          child: Ink(
            ...
            decoration: BoxDecoration(
              color: selected
                  ? AppColors.secondaryContainer.withValues(alpha: .30)
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: selected ? AppColors.secondaryContainer : AppColors.surface,
          borderRadius: BorderRadius.circular(999),
          border: Border.all(
            color: selected ? AppColors.ctaGold : AppColors.outlineVariant,
          ),
        ),
        child: Text(
          '${dt.day}/${dt.month} • ${TimeOfDay.fromDateTime(dt).format(context)}',
          style: TextStyle(
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Icon(icon, color: AppColors.tertiaryLight, size: 21),
