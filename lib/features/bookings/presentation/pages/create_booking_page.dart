      ...
      body: Form(
        ...
        child: Column(
          children: [
            ...
            Expanded(child: SingleChildScrollView(padding: const EdgeInsets.fromLTRB(20, 8, 20, 20), child: Column(children: [
    ...
    switch (_step) {
      ...
      case 1:
        return _StepCard(title: 'نوع الاستشارة', subtitle: 'حدد طريقة التواصل وطريقة تنفيذ الموعد.', icon: Icons.forum_outlined, child: Column(children: [
          ...
          DropdownButtonFormField<String>(value: _consultationMode, decoration: const InputDecoration(labelText: 'طريقة الموعد'), items: const [DropdownMenuItem(value: 'عن بعد', child: Text('عن بعد')), DropdownMenuItem(value: 'في المكتب', child: Text('في المكتب'))], onChanged: (value) => setState(() => _consultationMode = value ?? 'عن بعد')),
          const SizedBox(height: 14),
      ...
      case 3:
        return _StepCard(title: 'المراجعة والتأكيد', subtitle: 'راجع البيانات قبل إرسال طلب الاستشارة.', icon: Icons.fact_check_outlined, child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
          _ReviewRow(label: 'المحامي', value: widget.lawyer.name),
