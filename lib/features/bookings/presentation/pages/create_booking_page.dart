...
class _CreateBookingPageState extends ConsumerState<CreateBookingPage> {
  ...
  Future<void> _submit() async {
    ...
    if (booking == null) {
      _message(
        ref.read(bookingsControllerProvider).error?.toString().replaceFirst(
              'Exception: ',
            ) ??
            'تعذر إنشاء الحجز',
      );
        ...
        return _StepCard(
          ...
          child: widget.isCustom
              ...
              : widget.lawyer.services.isEmpty
                  ...
                  : Column(
                      children: widget.lawyer.services.map((service) {
                        return _SelectablePackage(
                          service: service,
          ...
          child: Column(
            children: [
              if (widget.isCustom)
                TextFormField(
                  ...
                  decoration: const InputDecoration(
                    ...
                    hintText: 'اكتب نوع الاستشارة المطلوبة',
              ...
              TextFormField(
                ...
                decoration: const InputDecoration(
                  labelText: 'وصف الطلب',
                  hintText: 'اكتب تفاصيل مختصرة عن استشارتك',
                ),
                validator: (value) {
                  if (value == null || value.trim().isEmpty) {
                    return 'اكتب وصفاً مختصراً للطلب';
                  }
                  return null;
                },
              ),
            ...
            data: (slots) {
              if (slots.isEmpty) {
                return const _InfoBox(
                  ...
                  text: 'جرّب العودة لاحقاً.',
                );
              }
              return Column(
                children: slots.map((slot) {
                  return _SelectableSlot(
                    slot: slot,
          ...
          child: Column(
            ...
            children: [
              ...
              if (_selectedSlot != null)
                _ReviewRow(
                  label: 'الموعد',
                  value: _formatSlot(_selectedSlot!),
                ),
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    Text('${lawyer.reviewCount} مراجعة'),
                  ],
                ),
              ],
            ),
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: selected ? AppColors.ctaGold : scheme.outlineVariant,
