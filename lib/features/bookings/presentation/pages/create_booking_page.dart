      ...
      child: Row(
        children: List.generate(labels.length, (index) {
          ...
          return Expanded(
            child: Row(
              children: [
                CircleAvatar(radius: 14, backgroundColor: active ? AppColors.ctaGold : scheme.surfaceContainerHighest, foregroundColor: active ? AppColors.primary : scheme.onSurfaceVariant, child: Text('${index + 1}', style: const TextStyle(fontSize: 12, fontWeight: FontWeight.bold))),
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [const Icon(Icons.star_rounded, size: 16, color: AppColors.ctaGold), const SizedBox(width: 3), Text(lawyer.rating.toStringAsFixed(1)), const SizedBox(width: 8), Text('${lawyer.reviewCount} مراجعة')]),
        ])),
      ]),
    );
  }
...
class _StepCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final scheme = Theme.of(context).colorScheme;
    return Container(width: double.infinity, padding: const EdgeInsets.all(18), decoration: BoxDecoration(color: scheme.surface, borderRadius: BorderRadius.circular(20), border: Border.all(color: scheme.outlineVariant)), child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
