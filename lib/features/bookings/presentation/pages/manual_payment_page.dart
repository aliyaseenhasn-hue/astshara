...
class _ManualPaymentPageState extends ConsumerState<ManualPaymentPage> {
  ...
  Future<void> _save() async {
    ...
    if (amount != widget.booking.price) {
      final confirmed = await showDialog<bool>(
            ...
            builder: (dialogContext) => AlertDialog(
              ...
              content: Text(
                'المبلغ المدخل ${_formatAmount(amount)} د.ع يختلف عن رسوم الحجز ${_formatAmount(widget.booking.price)} د.ع. هل تريد المتابعة؟',
              ),
              actions: [
                TextButton(
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('تم تسجيل المبلغ المستلم وتأكيد الدفع.')),
      );
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ElevatedButton.icon(
                ...
                label: Text(
                  _saving ? 'جاري حفظ الدفع...' : 'تسجيل المبلغ وتأكيد الدفع',
                ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'سجّل المبلغ الذي استلمته فعلياً من العميل قبل بدء الاستشارة.',
                  style: TextStyle(
                    color: scheme.onPrimaryContainer,
                    height: 1.45,
                  ),
  ...
  Widget _bookingSummary(
    ...
    final shortId = widget.booking.id.length >= 8
        ...
        child: Column(
          ...
          children: [
            ...
            _row(
              context,
              'رسوم الاستشارة',
              '${_formatAmount(widget.booking.price)} د.ع',
            ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'أدخل المبلغ الذي استلمته من العميل. إذا كان مختلفاً عن الرسوم المتوقعة سيطلب التطبيق تأكيداً إضافياً.',
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'لا تسجّل الدفع إلا بعد استلام المبلغ فعلياً. سيُحفظ وقت الاستلام ويُحدّث الحجز تلقائياً.',
