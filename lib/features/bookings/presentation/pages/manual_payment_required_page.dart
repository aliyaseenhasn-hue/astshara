...
class _ManualPaymentRequiredPageState extends State<ManualPaymentRequiredPage> {
  ...
  void _openPayment() {
    ...
    context
        .push('/manual-payment', extra: booking)
        .then((_) => _loadPendingBooking());
  }
              ...
              children: [
                ...
                if (_loading)
                  ...
                  _stateCard(
                    ...
                    'لا توجد دفعات معلقة',
                    'لا توجد حالياً دفعة مكتبية تحتاج إلى تسجيل. يمكنك تحديث الصفحة للتحقق من جديد.',
                    'تحديث',
                    _loadPendingBooking,
                  )
                else ...[
                  _bookingCard(context, textTheme, scheme),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.payments_rounded, color: scheme.primary, size: 28),
          ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'يوجد حجز حضوري يحتاج إلى تسجيل المبلغ المستلم قبل بدء الاستشارة.',
                  style: TextStyle(
                    color: scheme.onPrimaryContainer,
                    height: 1.45,
                  ),
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _row(context, 'رسوم الاستشارة', '${booking.price} د.ع'),
            _row(context, 'الحالة', booking.status),
          ],
        ),
      ),
    );
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
            child: Text(
              'سجّل المبلغ الذي استلمته فعلياً فقط. بعد التأكيد سيُحدّث الحجز وتصبح الاستشارة جاهزة وفق شروطها.',
