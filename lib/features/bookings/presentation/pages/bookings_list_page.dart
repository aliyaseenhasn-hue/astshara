        ...
        data: (bookings) {
          if (bookings.isEmpty) {
            return Center(child: Padding(padding: const EdgeInsets.all(24), child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Container(width: 82, height: 82, decoration: BoxDecoration(color: dark ? scheme.surfaceContainerHighest : AppColors.goldLight.withValues(alpha: .42), borderRadius: BorderRadius.circular(24)), child: Icon(Icons.calendar_month_outlined, size: 42, color: dark ? AppColors.gold : AppColors.goldDark)),
            ...
            itemBuilder: (context, index) {
              ...
              return Consumer(builder: (context, ref, child) {
                ...
                return Card(
                  ...
                  child: InkWell(borderRadius: BorderRadius.circular(20), onTap: () => context.push('/booking-details', extra: booking), child: Padding(padding: const EdgeInsets.all(16), child: Row(children: [
                    if (!isLawyer) ...[
                      CircleAvatar(radius: 28, backgroundColor: dark ? scheme.surfaceContainerHighest : AppColors.goldLight, backgroundImage: lawyerAvatar != null && lawyerAvatar.isNotEmpty ? NetworkImage(lawyerAvatar) : null, child: lawyerAvatar == null || lawyerAvatar.isEmpty ? Icon(Icons.person_outline, color: dark ? AppColors.gold : AppColors.goldDark) : null),
