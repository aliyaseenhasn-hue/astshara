...
class PaymentUploadPage extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<PaymentUploadPage> createState() =>
      _PaymentUploadPageState();
}
...
class _PaymentUploadPageState extends ConsumerState<PaymentUploadPage>
  ...
  Future<void> _refreshBookingAfterPayment() async {
    ...
    try {
      ...
      // سيتم الانتقال إلى صفحة الحجوزات في حالة تعذر تحديث البيانات.
    }
  ...
  Future<void> _checkPaymentStatus({
    ...
    try {
      ...
      final bookingStatus =
          result['booking_status']?.toString();
      ...
      // في حالة نجاح الدفع ولكن الحجز بانتظار مراجعة المحامي.
      if (bookingStatus == 'قيد مراجعة المحامي') {
        _pollTimer?.cancel();
