...
class _Trust extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    const items = [
      ...
      _TrustItem(Icons.verified_user_outlined, 'اعتماد ومراجعة'),
      _TrustItem(Icons.chat_bubble_outline_rounded, 'متابعة الطلب'),
      _TrustItem(Icons.phone_iphone_rounded, 'مصمم للموبايل'),
    ];
    return Padding(
        ...
        children: items.map((item) {
          return Container(
            ...
            child: Row(
              ...
              children: [
                Icon(item.icon, size: 17, color: s.primary),
                const SizedBox(width: 6),
                Text(item.text, style: TextStyle(fontWeight: FontWeight.w700, color: s.onSurface, fontSize: 12)),
              ],
            ),
          );
        }).toList(),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            children: [
              Text(number, style: TextStyle(color: s.primary.withValues(alpha: .55), fontSize: 24, fontWeight: FontWeight.w900)),
              Container(
                width: 46,
                height: 46,
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Expanded(child: Text(title, textAlign: TextAlign.center, style: TextStyle(color: s.onSurface, fontSize: 25, fontWeight: FontWeight.w900))),
