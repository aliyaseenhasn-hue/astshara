...
class ProfilePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: user == null
          ...
          : CustomScrollView(
              slivers: [
                // رأس الصفحة بتصميم متناسق (Navy Gradient)
                SliverAppBar(
                  expandedHeight: 220,
                  pinned: true,
                ...
                SliverPadding(
                  ...
                  sliver: SliverList(
                    delegate: SliverChildListDelegate([
                      ...
                      _buildProfileTile(Icons.help_outline_rounded,
                          'مركز المساعدة', () => context.push('/help-center')),
                      _buildProfileTile(
                          Icons.privacy_tip_outlined, 'سياسة الخصوصية', () {}),
                      const Padding(
  ...
  Future<void> _updateAvatar(WidgetRef ref) async {
    ...
    if (image != null) {
      ...
      // ملاحظة: نحتاج لوظيفة رفع الصور في AuthRepository
      // حالياً سنقوم بتحديث الاسم فقط كمثال، أو استدعاء uploadFile من LawyersRepository إذا كان المجلد عاماً
      // لكن الأصح هو إضافة uploadAvatar في AuthRepository
    }
  }
            ...
            onPressed: () async {
              await ref
                  ...
                  .updateInitialProfile(
                    ...
                    role: ref.read(authStateChangesProvider).value?.role ??
                        'user',
                  );
