...
- `50ba0847414535c9034dc6939c0d94b21c084bda` — صقل `profile_page.dart` مع الحفاظ على منطق الحساب.
...
- `19967f1a6cbcd8baa06de833bcdbde5511130372` — مطابقة `payment_methods_page.dart` مع Stitch Premium.
